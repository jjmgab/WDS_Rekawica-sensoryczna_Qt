...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        centralWidget->setBaseSize(QSize(1025, 590));
        ...
        label_orientationY->setCursor(QCursor(Qt::IBeamCursor));
        ...
        value_orientationY->setCursor(QCursor(Qt::ForbiddenCursor));
